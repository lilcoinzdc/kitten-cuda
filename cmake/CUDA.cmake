...
option(kitten_LARGEGRID "Support large CUDA block count > 128" ON)
if (kitten_LARGEGRID)
    add_definitions("-Dkitten_LARGEGRID=${kitten_LARGEGRID}")
endif()
...
if("${CUDA_COMPILER}" STREQUAL "clang")
    add_library(kitten-cu STATIC ${CUDA_SOURCES})

    set_target_properties(kitten-cu PROPERTIES COMPILE_FLAGS ${CLANG_BUILD_FLAGS})
    set_target_properties(kitten-cu PROPERTIES LINKER_LANGUAGE CXX)
    set_source_files_properties(${CUDA_SOURCES} PROPERTIES LANGUAGE CXX)
else()
    cuda_add_library(kitten-cu STATIC ${CUDA_SOURCES})
endif()
