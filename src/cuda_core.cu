...
* Copyright 2016-2018 kitten       <https://github.com/kitten>, <support@kitten.com>
*
 ...
 */
#if defined(kitten_LARGEGRID) && (__CUDA_ARCH__ >= 300)
 ...
 */
template<size_t ITERATIONS, uint32_t MEM, uint32_t MASK, kitten_cuda::Algorithm::Id ALGO>
#ifdef kitten_THREADS
__launch_bounds__( kitten_THREADS * 2 )
#endif
...
template<size_t ITERATIONS, uint32_t MEM, uint32_t MASK, kitten_cuda::Algorithm::Id ALGO, kitten_cuda::Algorithm::Id BASE>
#ifdef kitten_THREADS
__launch_bounds__( kitten_THREADS * 4 )
#endif
...
template<size_t ITERATIONS, uint32_t MEM, kitten_cuda::Algorithm::Id ALGO>
...
template<kitten_cuda::Algorithm::Id ALGO>
...
void cryptonight_gpu_hash(nvid_ctx *ctx, const kitten_cuda::Algorithm &algorithm, uint64_t height, uint32_t startNonce)
{
    using namespace kitten_cuda;
