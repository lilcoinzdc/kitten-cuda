 ...
 * Copyright 2016-2019 kitten       <https://github.com/kitten>, <support@kitten.com>
 *
...
int cryptonight_extra_cpu_init(nvid_ctx *ctx, const kitten_cuda::Algorithm &algorithm, size_t hashMemSize)
{
    using namespace kitten_cuda;
